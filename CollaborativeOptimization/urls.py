...
urlpatterns = [
    ...
    url(r'^api/v1/vnf4-uuid/', coviews.api4_vnf4_uuid),
    url(r'^api/v1/vnf5-uuid/', coviews.api4_vnf5_uuid),
    ...
    url(r'^api/v1/vnf4-itest/', coviews.api4_vnf4_itest),
    url(r'^api/v1/vnf5-itest/', coviews.api4_vnf5_itest),
    # 接收CPU MEMORY的结果
