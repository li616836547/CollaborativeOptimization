                  ...
                  switch(taskType)
                  {
                      case '1':
                          ...
                          var currentData = '<h6>设置session数：'+ data.set_session +'</h6>' +
                                ...
                                var progressData_point = data.current_session/data.set_session*100;
                                var progressData = Math.round(data.current_session/data.set_session*100) + "%";
                                $("#progressWidth").css("width", progressData);
                                $("#progressData").html("当前测试进度：" + progressData_point.toFixed(2) +'%');
