# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-30 13:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('traffic_status', models.CharField(default='-1', help_text='验证流量发送状态', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('task_id', models.UUIDField(help_text='测试用例ID')),
                ('set_flow', models.CharField(blank=True, default='-1', help_text='测试流量', max_length=100)),
                ('set_session', models.IntegerField(blank=True, default='-1', help_text='测试Session数')),
                ...
                ('set_online_rate', models.CharField(blank=True, default='-1', help_text='上线速率', max_length=100)),
                ...
                ('set_router_num', models.CharField(blank=True, default='-1', help_text='路由容量', max_length=100)),
                ('set_host_num', models.CharField(blank=True, default='-1', help_text='邻居数目', max_length=100)),
                ('set_router_learning_time', models.CharField(blank=True, default='-1', help_text='路由学习时间', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='UserTransTest',
